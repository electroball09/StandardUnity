...
public class DearImguiConsole : MonoBehaviour
{
    ...
    unsafe void Layout()
    {
        ...
        ImGui.Begin("window", ImGuiWindowFlags.NoResize | ImGuiWindowFlags.NoMove | ImGuiWindowFlags.NoTitleBar | ImGuiWindowFlags.MenuBar);
        ImGui.SetWindowSize("window", new Vector2(Screen.width, 200));
        ...
        Vector2 consoleSize = ImGui.GetWindowSize() - new Vector2(0, 60);
